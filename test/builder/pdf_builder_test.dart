...
void main() {
  ...
  group('PdfBuilder', () {
    ...
    test('builds encrypted PDF larger than unencrypted', () async {
      final builder1 = PdfBuilder(await pdf.createBuilder());
      final page1 = await builder1.addA4Page();
      await page1.paragraph('Secret content');
      await page1.done();
      final plain = await builder1.build();
      await builder1.dispose();

      final builder2 = PdfBuilder(await pdf.createBuilder());
      final page2 = await builder2.addA4Page();
      await page2.paragraph('Secret content');
      await page2.done();
      final encrypted = await builder2.buildEncrypted(ownerPassword: 'test123');
