...
export const wasmpdfdocument_dispatchOpen: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchExtractText: (a: number, b: number, c: number, d: number, e: number) => void;
export const wasmpdfdocument_dispatchSearch: (a: number, b: number, c: number, d: number, e: number) => void;
export const wasmpdfdocument_dispatchGetSignatures: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchVerifySignatures: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchValidatePdfA: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchValidatePdfUa: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchClassifyPage: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchClassifyDocument: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchPlanSplitByBookmarks: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchRenderPage: (a: number, b: number, c: number, d: number, e: number) => void;
export const wasmpdfdocument_dispatchExtractImages: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchEditSelectPages: (a: number, b: number, c: number, d: number) => void;
export const wasmpdfdocument_dispatchEditDeletePages: (a: number, b: number, c: number, d: number) => void;
export const wasmpdfdocument_dispatchEditRotatePages: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const wasmpdfdocument_dispatchEditRotateAll: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchEditFlattenForms: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchEditApplyRedactions: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchEditCompress: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchEditMovePage: (a: number, b: number, c: number, d: number) => void;
export const wasmpdfdocument_dispatchEditEmbedFile: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const wasmpdfdocument_dispatchEditEraseRegions: (a: number, b: number, c: number, d: number, e: number) => void;
export const wasmpdfdocument_dispatchEditWatermark: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number) => void;
export const wasmpdfdocument_dispatchEditAddStamp: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
export const wasmpdfdocument_dispatchEditAddImageStamp: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
export const wasmpdfdocument_dispatchEditSetTitle: (a: number, b: number, c: number, d: number) => void;
export const wasmpdfdocument_dispatchEditSetAuthor: (a: number, b: number, c: number, d: number) => void;
export const wasmpdfdocument_dispatchEditSetSubject: (a: number, b: number, c: number, d: number) => void;
export const wasmpdfdocument_dispatchEditSetKeywords: (a: number, b: number, c: number, d: number) => void;
export const wasmpdfdocument_dispatchEditOptimizeImages: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchEditUnembedStandardFonts: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchEditFlattenAllAnnotations: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchEditSetFormFieldValue: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const wasmpdfdocument_dispatchEditCropMargins: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const wasmpdfdocument_dispatchEditConvertToPdfA: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchEditResizeImage: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
export const wasmpdfdocument_dispatchEditAddRedaction: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
export const wasmpdfdocument_dispatchEditRedactionCount: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchEditApplyRedactionsDestructive: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchEditScrubMetadata: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchEditIsModified: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchEditPageMediaBox: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_dispatchEditSave: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const wasmpdfdocument_dispatchEditSaveEncrypted: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const wasmpdfdocument_dispatchEditorGetMetadata: (a: number, b: number) => void;
export const wasmpdfdocument_dispatchEditMerge: (a: number, b: number, c: number, d: number) => void;
export const wasmpdfdocument_dispatchConvertToFormat: (a: number, b: number, c: number, d: number) => void;
export const wasmpdfdocument_dispatchConvertFromFormat: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const wasmpdfdocument_dispatchImagesToPdf: (a: number, b: number, c: number) => void;
export const wasmdocumentbuilder_dispatchSetTitle: (a: number, b: number, c: number, d: number) => void;
export const wasmdocumentbuilder_dispatchSetAuthor: (a: number, b: number, c: number, d: number) => void;
export const wasmdocumentbuilder_dispatchSetSubject: (a: number, b: number, c: number, d: number) => void;
export const wasmdocumentbuilder_dispatchSetKeywords: (a: number, b: number, c: number, d: number) => void;
export const wasmdocumentbuilder_dispatchBuild: (a: number, b: number) => void;
export const __wbg_dispatchpagebuilder_free: (a: number, b: number) => void;
export const dispatchpagebuilder_new: (a: number, b: number) => number;
export const dispatchpagebuilder_dispatchPageOp: (a: number, b: number, c: number, d: number) => void;
export const dispatchpagebuilder_dispatchDone: (a: number, b: number, c: number) => void;
...
export const wasmpdfdocument_isModified: (a: number, b: number) => void;
...
export const wasmpdfdocument_dss: (a: number, b: number) => void;
...
export const wasmpdfdocument_isEncrypted: (a: number, b: number) => void;
export const wasmpdfdocument_requiresPassword: (a: number, b: number) => void;
export const wasmpdfdocument_getEncryptionAlgorithm: (a: number, b: number) => void;
export const wasmpdfdocument_getPermissionBits: (a: number, b: number) => void;
...
export const wasmpdfdocument_toDocxBytes: (a: number, b: number) => void;
export const wasmpdfdocument_toPptxBytes: (a: number, b: number) => void;
export const wasmpdfdocument_toXlsxBytes: (a: number, b: number) => void;
export const wasmpdfdocument_openFromDocxBytes: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_openFromPptxBytes: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_openFromXlsxBytes: (a: number, b: number, c: number) => void;
...
export const __wbg_revocationmaterial_free: (a: number, b: number) => void;
...
export const __wbg_dss_free: (a: number, b: number) => void;
...
export const signPdfStreamingPkcs12: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => void;
export const signPdfStreamingPem: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => void;
...
export const wasmsignature_padesLevel: (a: number) => number;
...
export const wasmpdfdocument_addRedaction: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
export const wasmpdfdocument_redactionCount: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_applyRedactionsDestructive: (a: number, b: number, c: number) => void;
export const wasmpdfdocument_sanitizeDocument: (a: number, b: number, c: number, d: number, e: number) => void;
...
export const wasmpdfdocument_selectPages: (a: number, b: number, c: number, d: number) => void;
...
export const wasmdss_crlCount: (a: number) => number;
export const wasmdss_ocspCount: (a: number) => number;
