...
/// Initialize the bridge on the worker isolate.
...
/// Create a NativeCallable.listener for read notifications.
///
...
///
/// Returns the NativeCallable (must be kept alive) and the function pointer.
...
/// Create a NativeCallable.listener for write notifications.
///
